...
PLS1.IN = SW1;
PLS1.PT = 1000;
writeBit("%QX0.0", ( ( SW2 ) || PLS1.Q ));
}


int main() {
  opcServer.mapVariable("SW1", "%IX0.0");
opcServer.mapVariable("SW2", "%IX0.1");
  opcServer.start();
...
mapIO("{\"ModuleID\":\"opc.tcp://localhost:4334/UA/nodalis\",\"ModulePort\":\"0\",\"Protocol\":\"OPCUA\",\"RemoteAddress\":\"Input1\",\"RemoteSize\":\"1\",\"InternalAddress\":\"%IX0.1\",\"Resource\":\"PLC1\",\"PollTime\":\"1000\",\"ProtocolProperties\":\"{}\"}");
